                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl><div className="flex gap-1"><Input {...field} type={confirmPasswordVisible ? "text" : "password"} /><Button size="icon" className="cursor-pointer" type="button" onClick={toggleConfirmVisibility}>{confirmPasswordVisible ? <EyeOff /> : <Eye />}</Button></div></FormControl>
                                    <FormMessage />
                                </FormItem>
                            )} />
